...
import javafx.util.Callback;
 ...
 /**
 *
 * Formatuje komórkę dostępności biletów 
 */
public class AvaibleTicketProgressTableCell<S> extends TableCell<S, Button>  {
    public final Hyperlink btKupBilet;
    ProgressBar determinateBar = new ProgressBar(0.5);

    public AvaibleTicketProgressTableCell(String label, Function< S, S> function) {
