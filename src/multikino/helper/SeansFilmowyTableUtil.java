...
public class SeansFilmowyTableUtil {
        ...
        private static ObservableList<SeansFilmowy> lista = null;
        public static ObservableList<SeansFilmowy> getSeansList() {
          
                if(lista == null)
                {
                    lista = FXCollections.<SeansFilmowy>observableArrayList();
                ...
                cenaCol.setMinWidth(65);
                 Callback<CellDataFeatures<SeansFilmowy, String>, ObservableValue<String>> cenaCellFactory =
                    ...
                    public ObservableValue<String> call(CellDataFeatures<SeansFilmowy, String> cellData) {
                        ...
                        p.setCena(new DecimalFormat("#.00").format(p.getPrice() * p.getSala().typ.val() + p.getSala().getOkulary3D())+" zł");
